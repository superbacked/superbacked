...
### Step 1: download [Ubuntu 24.04.3 LTS](https://ubuntu.com/download/desktop) and flash OS to USB flash drive using [Raspberry Pi Imager](https://www.raspberrypi.com/software/)

### Step 2: boot Ubuntu 24.04.3 LTS and select “Try Ubuntu”

### Step 3: using GParted, delete all partitions, apply changes and create `msdos` partition table

### Step 4: install Ubuntu 24.04.3 LTS while connected to the Internet
...
### Step 5: boot installed Ubuntu 24.04.3 LTS

### Step 6: select “No, don’t send system data”

### Step 7: update Ubuntu 24.04.3 LTS using `update-manager` without rebooting
...
### Step 10: boot Ubuntu 24.04.3 LTS and select “Try Ubuntu”

### Step 11: insert USB flash drive with `superbacked-os-utilities`, cd to `superbacked-os-utilities` and run `./superbacked-os-image.sh superbacked-os-amd64-24.04.3`.
