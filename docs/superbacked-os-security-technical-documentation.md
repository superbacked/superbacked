...
Superbacked OS exists to create and restore encrypted paper backups (“blocks”) of high-stakes secrets — critical credentials, signing keys and digital assets — and the encrypted file archives that can accompany them. (The cryptographic design of what it creates is documented separately: blocks in the [block technical documentation](block-technical-documentation.md), blocksets in the [blockset technical documentation](blockset-technical-documentation.md) and the file archives in the [standalone archive](standalone-archive-technical-documentation.md) and [detached archive](detached-archive-technical-documentation.md) technical documentation; this document is about the operating system that surrounds them.) It assumes the machine may be a target and aims to make a single compromised component as inert as possible: unable to reach the network, observe the room, watch other applications or reach storage it has no business touching.
...
| AppArmor profiles — one per app, commented rule-group by rule-group                  | [`firefox.profile`](../superbacked-os-bootstrap-assets/apparmor/firefox.profile), [`keepassxc.profile`](../superbacked-os-bootstrap-assets/apparmor/keepassxc.profile), [`superbacked.profile`](../superbacked-os-bootstrap-assets/apparmor/superbacked.profile), [`yubico-authenticator.profile`](../superbacked-os-bootstrap-assets/apparmor/yubico-authenticator.profile) |
...
- [Block](block-technical-documentation.md) and [Blockset](blockset-technical-documentation.md) technical documentation — the cryptographic design of the blocks and blocksets this OS creates and restores.
- [Standalone archive](standalone-archive-technical-documentation.md) and [Detached archive](detached-archive-technical-documentation.md) technical documentation — the encrypted file archives Superbacked can also create (standalone on their own, or detached during block or blockset creation).
